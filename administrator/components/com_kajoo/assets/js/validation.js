$(function() {
	...
	$("button#check").live("click", function(e){
		...
		var urlJSON = "http://www.freebandtech.com/index.php?option=com_freebandsubs&view=check&format=raw&validation="+validation+"&license="+license+"&url="+urlVal+"&callback=?"; 
